  ...
  return (
    <div>
      ...
      <div className="text-center text-[#0E0E0E] space-y-1 pt-6 lg:pt-12 pb-3 ">
        <p className="text-base leading-6 font-normal ">Undiscovered Recruit</p>
        <h3 className=" text-[22px] font-bold leading-8 ">About Us</h3>
      </div>

      {/* describe */}
      <p className=" text-[#000] leading-8 text-base text-start lg:text-center ">
        Welcome to Undiscovered Recruits, the innovative basketball recruitment
        and communication platform that seamlessly connects coaches and players.
        Our team comprises former college players and current and former college
        coaches who bring a wealth of experience and passion for the game. Our
        mission is to simplify the recruitment process, empowering players to be
        discovered by coaches while assisting coaches in finding new talent. We
        are dedicated to making it easier for players to get noticed by coaches
        and for coaches to find new undiscovered talent.
      </p>
      ...
      <div className=" px-6 py-4  lg:py-[100px]   lg:px-[50px] bg-primaryColor rounded-[15px] text-center">
        ...
        <p className="text-[#fff] text-base leading-8 font-normal ">
          We are a dedicated team of college basketball players and coaches with
          firsthand experience in the challenges and opportunities within the
          basketball industry. Our team understands the complexities of the
          recruitment process and is driven to create a solution that benefits
          everyone involved. Our deep understanding and passion drive us to
          create a platform that makes it easier for players to get recruited
          and for coaches to find the right talent.
        </p>
      </div>
      ...
      <div className=" py-12 lg:pt-[100px]   lg:pb-[120px] ">
        ...
        <div className="text-center space-y-3 ">
          ...
          <p className="text-base font-normal leading-8 text-[#000]">
            Our platform is a cutting-edge social media and web application
            designed specifically for the basketball community. It provides a
            seamless experience for both players and coaches, ensuring that
            everyone has access to the tools they need to succeed. Key features
            include:
          </p>
        </div>
