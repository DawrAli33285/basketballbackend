      ...
      <div className={`${isCollapsed ? "block" : "hidden"} w-full py-4 bg-[#F8FAFC]`}>
        <Collapse isOpened={isCollapsed}>
          ...
          <div className="flex my-[18px] gap-[25px] w-full ml-[45px]">
            ...
            <a href={player?.profile.socialLinks[1]?.link}><svg width="35" height="36" viewBox="0 0 35 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href={player?.profile.socialLinks[2]?.link}>
