  ...
  return (
    <div>
      ...
      <div>
       ...
       <p className="text-[21px] font-medium text-blue-500 leading-normal cursor-pointer hover:underline">
  {player?.auth?.name}
</p>
                  ...
                  <div className="flex items-center gap-[2px] text-[19px] font-normal text-[#000] leading-normal">
